...
<div class="div_header">
    ...
    <div class="btn_action_location">
        <!--直播按钮-->
        <a href="#" id="live" onclick="aa()">开始直播</a>
        ...
        <div class="broadcast_div_out">
            ...
            <div class="source">
                ...
                <div>
                    ...
                    <!--资源下载框-->
                    <div id="file_down" title="点击资源名称即可下载资源" style="color:white;position:relative;top:10px;width:350px;height:370px;text-align:left;overflow-x:hidden;overflow-y:auto;line-height:30px;">
                        <input type="button" value="资源名称" class="file_down_btn" /><br />
                        <input type="button" value="资源名称" class="file_down_btn" /><br />
                    </div>
